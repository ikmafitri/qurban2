...
<head>
  ...
  <title>Indahnya Berqurban</title>
        ...
        <div class="container">
            <div class="mbr-table">
                <div class="mbr-table-cell">
                         <a class="navbar-caption" href="">Indahnya Berqurban</a>
                </div>
                <div class="mbr-table-cell">
                    ...
                    <ul class="nav-dropdown collapse pull-xs-right nav navbar-nav navbar-toggleable-sm" id="exCollapsingNavbar">
                      <li class="nav-item"><a class="nav-link link mbr-editable-menu-item" href="index.html#home">HOME</a></li>
                      <li class="nav-item"><a class="nav-link link mbr-editable-menu-item" href="index.html#hukumqurban">HUKUM QURBAN</a></li>
                      <li class="nav-item"><a class="nav-link link mbr-editable-menu-item" href="index.html#about">ABOUT</a></li>
                      <li class="nav-item"><a class="nav-link link mbr-editable-menu-item" href="index.html#daftarpequrban">DAFTAR PEQURBAN</a></li>
                      <?php if ($this->session->userdata('logged_in') == TRUE): ?>
                        <li class="nav-item"><a class="nav-link link mbr-editable-menu-item" href="<?php echo base_url() ?>login/logout">LOGOUT</a></li>
                      <?php else: ?>
                        <li class="nav-item"><a class="nav-link link mbr-editable-menu-item" href="<?php echo base_url() ?>login">LOGIN</a></li>
                      <?php endif; ?>
                      <li class="nav-item nav-btn"><a class="nav-link btn btn-white btn-white-outline mbr-editable-menu-item" href="index.html#pricing-table2-f">Qurban Sekarang !</a></li>
                    </ul>
...
<section class="mbr-section mbr-section-hero mbr-section-full header2 mbr-parallax-background mbr-after-navbar" id="home" style="background-image: url(<?php echo $url; ?>assets/images/f-mwo-dznni-averie-woodard-2000x2000.jpg);">
                ...
                <div class="mbr-section row">
                    <div class="mbr-table-md-up">
                        <div class="mbr-table-cell col-md-5 content-size text-xs-center text-md-right">
                            <center><h3 class="mbr-section-title display-2">MARI BERQURBAN</h3></center>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <div class="mbr-arrow mbr-arrow-floating hidden-sm-down" aria-hidden="true"><a href="#hukumqurban"><i class="mbr-arrow-icon"></i></a></div>
</section>
<!-- 1 PAGES -->
<section class="mbr-section mbr-section__container article" id="hukumqurban" style="background-color: rgb(244, 244, 244); padding-top: 60px; padding-bottom: 0px;">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
                <center><h3 class="mbr-section-title display-2">Hukum Qurban</h3></center>
            </div>
        </div>
    </div>
</section>
...
<div style="text-align:justify"><h5>Berkurban merupakan bagian dari Syariat Islam yang sudah ada semenjak manusia ada. Ketika putra-putra nabi Adam AS diperintahkan berqurban. Maka Allah SWT menerima qurban yang baik dan diiringi ketakwaan dan menolak qurban yang buruk. Allah SWT berfirman: 
...
<h5></div><h4>Binatang yang Boleh Diqurbankan</h4>

<div style="text-align:justify"><h5>Adapun binatang yang boleh digunakan untuk berqurban adalah binatang ternak (Al-An’aam), unta, sapi dan kambing, jantan atau betina. Sedangkan binatang selain itu seperti burung, ayam dll tidak boleh dijadikan binatang qurban. Allah SWT berfirman: 
...
</h5></div><h4>Pembagian Daging Qurban</h4>
...
</h5><div><h4>Waktu Penyembelihan Qurban</h4>
...
</h5></div><h4>Berqurban dengan Cara Patungan</h4>
<div style="text-align:justify"><h5>Qurban dengan cara patungan, disebutkan dalam hadits dari Abu Ayyub Al-Anshari: 
...
</h5></div><h4>Hukum Menjual Bagian Qurban</h4>
<div style="text-align:justify"><h5>Orang yang berqurban tidak boleh menjual sedikitpun hal-hal yang terkait dengan hewan qurban seperti, kulit, daging, susu dll dengan uang yang menyebabkan hilangnya manfaat barang tersebut. Jumhur ulama menyatakan hukumnya makruh mendekati haram, sesuai dengan hadits: 
...
</h5></div><h4>Hukum Memberi Upah Tukang Jagal Qurban</h4>
<div style="text-align:justify"><h5>Sesuatu yang dianggap makruh mendekati haram juga memberi upah tukang jagal dari hewan qurban. Sesuai dengan hadits dari Ali RA: 
...
</h5></div><h4>Hukum Berqurban Atas Nama Orang yang Meninggal</h4>
<div style="text-align:justify"><h5>
...
</h5></div><h4>Kategori Penyembelihan</h4>
<div style="text-align:justify"><h5>
...
<!-- 1 PAGES -->
<section class="mbr-section mbr-section__container article" id="about" style="background-color: rgb(244, 244, 244); padding-top: 60px; padding-bottom: 0px;">
    <div class="container">
        <div class="row">
            <div class="col-xs-12">
              </br>
                <center><h3 class="mbr-section-title display-2">ABOUT</h3></center>
            </div>
        </div>
    </div>
</section>
...
<section class="mbr-section article mbr-section__container" id="content1-j" style="background-color: rgb(244, 244, 244); padding-top: 20px; padding-bottom: 20px;">
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-xs-12 lead"><h4></br>Head Office</h4>
  <h5>Bandung, Indonesia</h5>
  <h5>Ph. +62 21 2940 6565</br></br></br></br>
  Informasi Rekening :</br>
  BCA   |   6760 1767 60</br>
  Atas Nama Indahnya Berqurban</br></br></br>
  Mohon Konfirmasi Setelah Transfer</br>
  SMS : 0853 3000 6000</br>
  Email : info@indahnyaberqurban.com</br>
  </br>
  </br>
  </br>
      ...
      <div class="container">
          <div class="row">
              <div class="col-xs-12 text-xs-center">
                  <h3 class="mbr-section-title display-2">LANGKAH MUDAH UNTUK BERQURBAN</h3>
                  <small class="mbr-section-subtitle">Kami menyediakan 2 jenis hewan qurban.</small>
              </div>
          </div>
      </div>
    </div>
                ...
                <div class="mbr-plan card text-xs-center">
                    <div class="mbr-plan-header card-block">
                      ...
                      <div class="card-title">
                        <h3 class="mbr-plan-title">QURBAN SAPI</h3>
                        <small class="mbr-plan-subtitle">Nominal</small>
                      </div>
                      <div class="card-text">
                          <div class="mbr-price">
                            <span class="mbr-price-value">Rp.</span>
                            <span class="mbr-price-figure"><?php echo number_format($h_sapi->harga, 0, ',', '.'); ?></span><small class="mbr-price-term">/ekor.</small>
                          </div>
                    ...
                    <div class="mbr-plan-body card-block">
                      ...
                      <div class="mbr-plan-btn"><a href="<?php echo base_url().'qurban/sapi' ?>" class="btn btn-black btn-black-outline">PILIH</a></div>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xs-12 col-md-6 col-xl-6">
                <div class="mbr-plan card text-xs-center">
                    <div class="mbr-plan-header card-block">
                      ...
                      <div class="card-title">
                        <h3 class="mbr-plan-title">QURBAN KAMBING</h3>
                        <small class="mbr-plan-subtitle">Nominal</small>
                      </div>
                      <div class="card-text">
                          <div class="mbr-price">
                            <span class="mbr-price-value">Rp.</span>
                            <span class="mbr-price-figure"><?php echo number_format($h_kambing->harga, 0, ',', '.'); ?></span><small class="mbr-price-term">/ekor.</small>
                          </div>
                          <small class="mbr-plan-price-desc"></small>
                      </div>
                    </div>
                    <div class="mbr-plan-body card-block">
                      <!-- <div class="mbr-plan-list"><ul class="list-group list-group-flush"><li class="list-group-item">32 GB storage</li><li class="list-group-item">Unlimited users</li><li class="list-group-item">15 GB bandwidth</li></ul></div> -->
                      <div class="mbr-plan-btn"><a href="<?php echo base_url().'qurban/kambing' ?>" class="btn btn-black btn-black-outline">PILIH</a></div>
                    </div>
                </div>
            </div>
          </div>
